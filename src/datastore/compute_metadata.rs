...
/// TODO doc
pub async fn get_token() -> std::result::Result<String, DsClientError> {
...
/// TODO doc
pub async fn get_project_id() -> std::result::Result<String, DsClientError> {
...
/// TODO doc
pub async fn get_metadata(entry: &'static str) -> std::result::Result<body::Bytes, DsClientError> {
